...
const ResourceTypeIdRoute = ResourceTypeIdRouteImport.update({
  id: '/resource/$type/$id',
  path: '/resource/$type/$id',
  getParentRoute: () => rootRouteImport,
} as any)
const OtherTypeIdRoute = OtherTypeIdRouteImport.update({
  id: '/other/$type/$id',
  path: '/other/$type/$id',
  getParentRoute: () => rootRouteImport,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/resource/$type/$id': {
      id: '/resource/$type/$id'
      path: '/resource/$type/$id'
      fullPath: '/resource/$type/$id'
      preLoaderRoute: typeof ResourceTypeIdRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/other/$type/$id': {
      id: '/other/$type/$id'
      path: '/other/$type/$id'
      fullPath: '/other/$type/$id'
      preLoaderRoute: typeof OtherTypeIdRouteImport
      parentRoute: typeof rootRouteImport
    }
  }
}
